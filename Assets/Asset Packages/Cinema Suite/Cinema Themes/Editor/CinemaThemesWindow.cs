...
#region Language
    ...
    protected void AddThemeToCamera(Texture2D theme, Camera camera)
    {
        ...
        {
            UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(camera.gameObject, "Assets/Asset Packages/Cinema Suite/Cinema Themes/Editor/CinemaThemesWindow.cs (311,13)", "ColorCorrectionLut");
        }
